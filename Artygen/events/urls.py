...
from .views import EventListView, EventDetailView, event_create, event_update, event_delete, generate_event_description
from . import views
...
urlpatterns = [
    ...
    path('generate-description/', generate_event_description, name='generate_event_description'),
